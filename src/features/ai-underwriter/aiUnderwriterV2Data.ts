...
export const aiUnderwriterStatusMetrics: AuditMetric[] = [
  ...
  { label: 'Models Online', value: '12', detail: 'Underwriting modules', tone: 'cyan', score: 100 },
...
export const commandCenterMetrics: AuditMetric[] = [
  { label: 'Approval Probability', value: '92%', detail: 'V1 live signal', tone: 'green', score: 92 },
  { label: 'V2 Shadow Confidence', value: '91%', detail: 'Independent audit', tone: 'cyan', score: 91 },
  { label: 'Predicted Default Risk', value: '2.4%', detail: 'Low risk', tone: 'green', score: 88 },
  { label: 'Expected Yield', value: '18.2%', detail: 'AutoDeFi pool', tone: 'purple', score: 86 },
...
export const auditModules: AuditModuleSummary[] = [
  ...
  { id: 'approval-probability', moduleNumber: 10, label: 'Approval Probability', shortLabel: 'AI Approval Score', subtitle: 'Approval likelihood, decision strength, confidence, and scenario analysis.', status: 'active', confidence: 92, score: 86, decisionImpact: 8, riskAdjustment: -4, v1Signal: 'Approve with standard terms', v2LearningSignal: 'Back-test approval probability against live deal performance.', reasonCodes: ['APPROVAL_PROBABILITY_HIGH', 'DECISION_STRENGTH_STRONG'] },
  { id: 'default-risk', moduleNumber: 11, label: 'Default Risk', shortLabel: 'Default & Payment Risk', subtitle: 'Probability of default, loss given default, expected loss, and recovery outlook.', status: 'pending', confidence: 88, score: 23, decisionImpact: 6, riskAdjustment: -2.1, v1Signal: 'Low default risk', v2LearningSignal: 'Tune PD/LGD using actual delinquency, recovery, and pool loss data.', reasonCodes: ['DEFAULT_RISK_LOW', 'PAYMENT_HISTORY_STRONG'] },
  { id: 'best-funding-source', moduleNumber: 12, label: 'Best Funding Source', shortLabel: 'Optimal Funding Match', subtitle: 'Funding terms, lender match, payment options, and cost analysis.', status: 'pending', confidence: 91, score: 91, decisionImpact: 7, riskAdjustment: -3, v1Signal: 'AutoDeFi Capital Pool best match', v2LearningSignal: 'Learn which funding sources produce best risk-adjusted outcomes.', reasonCodes: ['FUNDING_SOURCE_MATCH_STRONG', 'TERMS_COMPETITIVE'] },
  { id: 'yield-to-lenders', moduleNumber: 13, label: 'Yield to Lenders', shortLabel: 'Expected Lender Yield', subtitle: 'Risk-adjusted yield, lender profitability, demand, and allocation.', status: 'pending', confidence: 88, score: 88, decisionImpact: 8, riskAdjustment: -3, v1Signal: 'High yield confidence', v2LearningSignal: 'Compare expected yield against realized pool yield after reserves and losses.', reasonCodes: ['YIELD_STRONG', 'LENDER_DEMAND_HIGH'] },
  { id: 'final-action', moduleNumber: 14, label: 'Final Action', shortLabel: 'Decision & Offer', subtitle: 'Final decision, offer terms, conditions, next steps, and report export.', status: 'pending', confidence: 86, score: 86, decisionImpact: 0, riskAdjustment: 0, v1Signal: 'Approve with standard terms', v2LearningSignal: 'Audit final offer accuracy against repayment and funding outcomes.', reasonCodes: ['FINAL_APPROVE_STANDARD_TERMS', 'CONDITIONS_PENDING_FINAL_ESIGN'] },
  { id: 'audit-program-settings', moduleNumber: 15, label: 'Audit Program Settings', shortLabel: 'System Configuration', subtitle: 'Scoring weights, thresholds, data sources, permissions, and model governance.', status: 'pending', confidence: 100, score: 100, decisionImpact: 0, riskAdjustment: 0, v1Signal: 'Configuration active', v2LearningSignal: 'Govern recursive learning, retraining, promotion gates, and rollback policies.', reasonCodes: ['V2_SHADOW_MODE_LOCKED', 'HUMAN_PROMOTION_GATE_REQUIRED'] }
];
